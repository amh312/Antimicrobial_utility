...
susc_plotter <- function(df,subset="",measure,suffix="",agent_col1,agent_name1,agent_col2,agent_name2,variable) {
...
susc_plotter_iv <- function(df,subset="",measure,suffix="",agent_col1,agent_name1,variable) {
...
###Combination illness severity sensitivity analysis
all_singles <- c("AMP","SAM","TZP","CZO","CRO","CAZ","FEP",
                 "MEM","CIP","GEN","SXT","NIT","VAN")
ab_singles <- all_singles
all_combos <- combn(all_singles, 2, FUN = function(x) paste(x, collapse = "_"))
...
oviv_list_combo <- c()
ovor_list_combo <- c()
pdrx1_list_combo <- data.frame(PDRx_1=all_abs)

for(weight in seq_along(weightseq)) {
  
  combo_res_sens_analysis(ur_util,util_probs_df,MEWS_variable=weightseq[weight],R_value=1)
  ...
  pdrx1_list_combo <- pdrx1_list_combo %>% left_join(abrx1_df,by="PDRx_1")
  colnames(pdrx1_list_combo)[weight+1] <- weightseq[weight]
...
pdrx1_list_combo[is.na(pdrx1_list_combo)] <- 0
pdrx1_df_combo <- pdrx1_list_combo %>% filter(rowSums(select(.,2:ncol(pdrx1_list_combo)))!=0)
pdrx1_df_combo <- melt(pdrx1_df_combo)
colnames(pdrx1_df_combo) <- c("Antimicrobial","Illness severity","Percentage of first-line recommendations")
replace_values <- function(column, map) {
...
pdrx1_df_combo <- pdrx1_df_combo %>% mutate(Antimicrobial=replace_values(Antimicrobial, combined_antimicrobial_map))
pdrx1_df_combo <- pdrx1_df_combo %>% mutate(`Percentage of first-line recommendations`=
                                  (`Percentage of first-line recommendations`/nrow(ur_util))*100)

write_csv(pdrx1_df_combo,"comboplot_df.csv")

comboplot <- ggplot(pdrx1_df_combo,aes(x=`Illness severity`,y=`Percentage of first-line recommendations`,group=Antimicrobial,colour=Antimicrobial))+
  geom_line()+
  theme_minimal()+
  theme(panel.grid = element_blank())+
  ggtitle("First-line automated recommendations (including combinations) according to illness severity")+
  scale_x_discrete(breaks = NULL)+
  ylim(0,100)

ggsave(glue("ilness_comboplot.pdf"), plot = comboplot, device = "pdf", width = 10, height = 6,
       path="/Users/alexhoward/Documents/Projects/UDAST_code")

print(comboplot)

overall_plot_df_combo <- data.frame(rbind(
  overall_perclist_combo,ovac_list_combo,oviv_list_combo,ovor_list_combo
))
...
###Illness severity sensitivity analysis with improved probability predictions
all_singles <- c("AMP","SAM","TZP","CZO","CRO","CAZ","FEP",
                 "MEM","CIP","GEN","SXT","NIT","VAN")
ab_singles <- all_singles
all_combos <- combn(all_singles, 2, FUN = function(x) paste(x, collapse = "_"))
...
util_probs_df <- util_probs_df %>% mutate(better_S=case_when(Antimicrobial=="Ampicillin"&AMP=="R"~S/2,
                                                             Antimicrobial=="Ampicillin"&AMP=="S"~(S+1)/2,Antimicrobial=="Ampicillin"&AMP=="S"~R/2,
                                                             Antimicrobial=="Ampicillin-sulbactam"&SAM=="R"~S/2,
                                                             Antimicrobial=="Ampicillin-sulbactam"&SAM=="S"~(S+1)/2,
                                                             Antimicrobial=="Piperacillin-tazobactam"&TZP=="R"~S/2,
                                                             Antimicrobial=="Piperacillin-tazobactam"&TZP=="S"~(S+1)/2,
                                                             Antimicrobial=="Cefazolin"&CZO=="R"~S/2,
                                                             Antimicrobial=="Cefazolin"&CZO=="S"~(S+1)/2,
                                                             Antimicrobial=="Ceftriaxone"&CRO=="R"~S/2,
                                                             Antimicrobial=="Ceftriaxone"&CRO=="S"~(S+1)/2,
                                                             Antimicrobial=="Ceftazidime"&CAZ=="R"~S/2,
                                                             Antimicrobial=="Ceftazidime"&CAZ=="S"~(S+1)/2,
                                                             Antimicrobial=="Cefepime"&FEP=="R"~S/2,
                                                             Antimicrobial=="Cefepime"&FEP=="S"~(S+1)/2,
                                                             Antimicrobial=="Meropenem"&MEM=="R"~S/2,
                                                             Antimicrobial=="Meropenem"&MEM=="S"~(S+1)/2,
                                                             Antimicrobial=="Ciprofloxacin"&CIP=="R"~S/2,
                                                             Antimicrobial=="Ciprofloxacin"&CIP=="S"~(S+1)/2,
                                                             Antimicrobial=="Gentamicin"&GEN=="R"~S/2,
                                                             Antimicrobial=="Gentamicin"&GEN=="S"~(S+1)/2,
                                                             Antimicrobial=="Trimethoprim-sulfamethoxazole"&SXT=="R"~S/2,
                                                             Antimicrobial=="Trimethoprim-sulfamethoxazole"&SXT=="S"~(S+1)/2,
                                                             Antimicrobial=="Nitrofurantoin"&NIT=="R"~S/2,
                                                             Antimicrobial=="Nitrofurantoin"&NIT=="S"~(S+1)/2,
                                                             Antimicrobial=="Vancomycin"&VAN=="R"~S/2,
                                                             Antimicrobial=="Vancomycin"&VAN=="S"~(S+1)/2,
                                                             TRUE~NA))
weightseq <- seq(0,30,2.5)
iv_perclist_imp <- c()
po_perclist_imp <- c()
...
oviv_list_imp <- c()
ovor_list_imp <- c()
pdrx1_list_imp <- data.frame(PDRx_1=ab_singles)

for(weight in seq_along(weightseq)) {
  
  res_sens_analysis_2(ur_util,util_probs_df,MEWS_variable=weightseq[weight])
  ...
  ovor_list_imp <- c(ovor_list_imp,overall_s_oral)
  oviv_list_imp <- c(oviv_list_imp,overall_s_iv)
  pdrx1_list_imp <- pdrx1_list_imp %>% left_join(abrx1_df,by="PDRx_1")
  colnames(pdrx1_list_imp)[weight+1] <- weightseq[weight]
...
pdrx1_df_imp <- pdrx1_list_imp %>% filter(rowSums(select(.,2:ncol(pdrx1_list_imp)))!=0)
...
pdrx1_df_imp <- pdrx1_df_imp %>% mutate(Antimicrobial = ab_name(Antimicrobial))
pdrx1_df_imp <- pdrx1_df_imp %>% mutate(`Percentage of first-line recommendations`=
                                  (`Percentage of first-line recommendations`/nrow(ur_util))*100)

write_csv(pdrx1_df_imp,"impplot_df.csv")

impplot <- ggplot(pdrx1_df_imp,aes(x=`Illness severity`,y=`Percentage of first-line recommendations`,group=Antimicrobial,colour=Antimicrobial))+
  geom_line()+
  theme_minimal()+
  theme(panel.grid = element_blank())+
  ggtitle("First-line automated recommendations according to illness severity (improved predictions)")+
  scale_x_discrete(breaks = NULL)+
  ylim(0,100)

ggsave(glue("ilness_impplot.pdf"), plot = impplot, device = "pdf", width = 10, height = 6,
       path="/Users/alexhoward/Documents/Projects/UDAST_code")

print(impplot)

overall_plot_df_imp <- data.frame(rbind(
  overall_perclist_imp,ovac_list_imp,oviv_list_imp,ovor_list_imp
))
...
###2nd-line illness severity sensitivity analysis
all_singles <- c("AMP","SAM","TZP","CZO","CRO","CAZ","FEP",
                 "MEM","CIP","GEN","SXT","NIT","VAN")
ab_singles <- all_singles
all_combos <- combn(all_singles, 2, FUN = function(x) paste(x, collapse = "_"))
...
oviv_list_2nd <- c()
ovor_list_2nd <- c()
pdrx1_list_2nd <- data.frame(PDRx_2=ab_singles)

for(weight in seq_along(weightseq)) {
  
  res_sens_analysis_4(ur_util,util_probs_df,MEWS_variable=weightseq[weight],R_value=1)
  ...
  ovor_list_2nd <- c(ovor_list_2nd,overall_s_oral)
  oviv_list_2nd <- c(oviv_list_2nd,overall_s_iv)
  pdrx1_list_2nd <- pdrx1_list_2nd %>% left_join(abrx1_df,by="PDRx_2")
  colnames(pdrx1_list_2nd)[weight+1] <- weightseq[weight]
...
ovor_list_2nd <- ovor_list_2nd %>% label_binder("Oral agents")
oviv_list_2nd <- oviv_list_2nd %>% label_binder("IV agents")
...
ovor_list_2nd <- ovor_list_2nd %>% rename(Percentage = "vec")
oviv_list_2nd <- oviv_list_2nd %>% rename(Percentage = "vec")

pdrx1_list_2nd[is.na(pdrx1_list_2nd)] <- 0
pdrx1_df_2nd <- pdrx1_list_2nd %>% filter(rowSums(select(.,2:ncol(pdrx1_list_2nd)))!=0)
pdrx1_df_2nd <- melt(pdrx1_df_2nd)
colnames(pdrx1_df_2nd) <- c("Antimicrobial","Illness severity","Percentage of first-line recommendations")
pdrx1_df_2nd <- pdrx1_df_2nd %>% mutate(Antimicrobial = ab_name(Antimicrobial))
pdrx1_df_2nd <- pdrx1_df_2nd %>% mutate(`Percentage of first-line recommendations`=
                                          (`Percentage of first-line recommendations`/nrow(ur_util))*100)

write_csv(pdrx1_df_2nd,"secplot_df.csv")

secplot <- ggplot(pdrx1_df_2nd,aes(x=`Illness severity`,y=`Percentage of first-line recommendations`,group=Antimicrobial,colour=Antimicrobial))+
  geom_line()+
  theme_minimal()+
  theme(panel.grid = element_blank())+
  ggtitle("Second-line automated recommendations according to illness severity")+
  scale_x_discrete(breaks = NULL)+
  ylim(0,100)

ggsave(glue("ilness_2ndplot.pdf"), plot = secplot, device = "pdf", width = 10, height = 6,
       path="/Users/alexhoward/Documents/Projects/UDAST_code")

print(secplot)

overall_plot_df_2nd <- data.frame(rbind(
  overall_perclist_2nd,ovac_list_2nd,oviv_list_2nd,ovor_list_2nd
))
...
###Illness severity sensitivity analysis (CDI, toxicity, and cost)
weightseq <- seq(0,30,2.5)
cdi_medlist <- c()
cdi_q1list <- c()
cdi_q3list <- c()
