...
```{r, echo=FALSE,message=FALSE,warning=FALSE}
knitr::include_graphics("#FILEPATH#/Data flow chart.pdf")
```
...
3.  To balance computational time with performance, learning rates were tested by starting at a value of 0.1 then halving them or adding 0.1 as required (up to a maximum of 0.3) until the number of boosting rounds at which AUROC did not improve for 50 rounds was between 200 and 1,000. If models did not converge within 1,000 boosting rounds at a learning rate of 0.3, the process was started again at 0.1 but with a fixed maximum tree depth of 0.6 to limit model complexity and speed up convergence.
...
A single validation run was performed with the final trained model on the validation dataset, measuring AUROC, accuracy, precision, recall, and F1 score (decision threshold 0.5) using coded formulae for each model, with 95% confidence intervals approximated using bootstrapping.

A model stability analysis was performed to assess the performance of each model when trained on a smaller training dataset. Training and validation of the final model was performed in six random train-test splits without replacement (stratified by outcome) for each of four smaller train-test dataset size ratios (2:98%, 6:94%, 10:90%, and 14:86%) - AUROC, accuracy, precision, recall, and F1 score were measured for each of these validations, and metric distributions were plotted using dot plots to assess heterogeneity in performance.
...
hyp_tab <- read_csv("#FILEPATH#/hyp_tab_singles.csv")

knitr::kable(hyp_tab)

```

### Appendix 7: Final training hyperparameters used for the clinical prediction models.
\
...
feat_table <- read_csv("#FILEPATH#/feat_table_singles.csv")
...
knitr::include_graphics("#FILEPATH#/stability_AUC-ROC.pdf")
knitr::include_graphics("#FILEPATH#/stability_Precision.pdf")
knitr::include_graphics("#FILEPATH#/stability_Recall.pdf")
knitr::include_graphics("#FILEPATH#/stability_F1 score.pdf")
knitr::include_graphics("#FILEPATH#/stability_Accuracy.pdf")
...
knitr::include_graphics("#FILEPATH#/timesens_2008 - 2010_AUC-ROC.pdf")
knitr::include_graphics("#FILEPATH#/timesens_2008 - 2010_Precision.pdf")
knitr::include_graphics("#FILEPATH#/timesens_2008 - 2010_Recall.pdf")
knitr::include_graphics("#FILEPATH#/timesens_2008 - 2010_F1 score.pdf")
knitr::include_graphics("#FILEPATH#/timesens_2008 - 2010_Accuracy.pdf")

knitr::include_graphics("#FILEPATH#/timesens_2011 - 2013_AUC-ROC.pdf")
knitr::include_graphics("#FILEPATH#/timesens_2011 - 2013_Precision.pdf")
knitr::include_graphics("#FILEPATH#/timesens_2011 - 2013_Recall.pdf")
knitr::include_graphics("#FILEPATH#/timesens_2011 - 2013_F1 score.pdf")
knitr::include_graphics("#FILEPATH#/timesens_2011 - 2013_Accuracy.pdf")

knitr::include_graphics("#FILEPATH#/timesens_2014 - 2016_AUC-ROC.pdf")
knitr::include_graphics("#FILEPATH#/timesens_2014 - 2016_Precision.pdf")
knitr::include_graphics("#FILEPATH#/timesens_2014 - 2016_Recall.pdf")
knitr::include_graphics("#FILEPATH#/timesens_2014 - 2016_F1 score.pdf")
knitr::include_graphics("#FILEPATH#/timesens_2014 - 2016_Accuracy.pdf")

knitr::include_graphics("#FILEPATH#/timesens_2017 - 2019_AUC-ROC.pdf")
knitr::include_graphics("#FILEPATH#/timesens_2017 - 2019_Precision.pdf")
knitr::include_graphics("#FILEPATH#/timesens_2017 - 2019_Recall.pdf")
knitr::include_graphics("#FILEPATH#/timesens_2017 - 2019_F1 score.pdf")
knitr::include_graphics("#FILEPATH#/timesens_2017 - 2019_Accuracy.pdf")
...
knitr::include_graphics("#FILEPATH#/protchar_Age group_AUC-ROC.pdf")
knitr::include_graphics("#FILEPATH#/protchar_Age group_Precision.pdf")
knitr::include_graphics("#FILEPATH#/protchar_Age group_Recall.pdf")
knitr::include_graphics("#FILEPATH#/protchar_Age group_F1 score.pdf")
knitr::include_graphics("#FILEPATH#/protchar_Age group_Accuracy.pdf")

knitr::include_graphics("#FILEPATH#/protchar_Race_AUC-ROC.pdf")
knitr::include_graphics("#FILEPATH#/protchar_Race_Precision.pdf")
knitr::include_graphics("#FILEPATH#/protchar_Race_Recall.pdf")
knitr::include_graphics("#FILEPATH#/protchar_Race_F1 score.pdf")
knitr::include_graphics("#FILEPATH#/protchar_Race_Accuracy.pdf")

knitr::include_graphics("#FILEPATH#/protchar_(Gender|Language|Marital)_AUC-ROC.pdf")
knitr::include_graphics("#FILEPATH#/protchar_(Gender|Language|Marital)_Precision.pdf")
knitr::include_graphics("#FILEPATH#/protchar_(Gender|Language|Marital)_Recall.pdf")
knitr::include_graphics("#FILEPATH#/protchar_(Gender|Language|Marital)_F1 score.pdf")
knitr::include_graphics("#FILEPATH#/protchar_(Gender|Language|Marital)_Accuracy.pdf")
...
knitr::include_graphics("#FILEPATH#/Medicine_importances.pdf")
knitr::include_graphics("#FILEPATH#/Surgery_importances.pdf")
knitr::include_graphics("#FILEPATH#/Infection_importances.pdf")
knitr::include_graphics("#FILEPATH#/Intensive care_importances.pdf")
knitr::include_graphics("#FILEPATH#/General Practice_importances.pdf")
...
knitr::include_graphics("#FILEPATH#/utility_Treatment_ (single agent, medical specialties).pdf")
knitr::include_graphics("#FILEPATH#/utility_Treatment_ (single agent, surgical specialties).pdf")
knitr::include_graphics("#FILEPATH#/utility_Treatment_ (single agent, infection specialties).pdf")
knitr::include_graphics("#FILEPATH#/utility_Treatment_ (single agent, intensive care).pdf")
knitr::include_graphics("#FILEPATH#/utility_Treatment_ (single agent, general practice).pdf")
...
knitr::include_graphics("#FILEPATH#/UF_All agents_WHO access agents_plot.pdf")
knitr::include_graphics("#FILEPATH#/UF_IV agents_Oral agents_plot.pdf")
