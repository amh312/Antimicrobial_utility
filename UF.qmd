...
Final training hyperparameters used for each model are summarised in Appendix 4, and predictor variable contributions to predictive accuracy are summarised in Appendix 5.
...
#| fig.cap: "Appendix 1: Data processing workflow."
```
...
knitr::kable(hyp_tab,
             caption = "Final training hyperparameters used for the 39 clinical prediction models.")
...
knitr::kable(feat_table,
             caption = "Feature importances in the clinical prediction models.")
