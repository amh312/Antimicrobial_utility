...
reticulate::source_python("/Users/alexhoward/Documents/Projects/UDAST_code//UF_train_test_main.py")

###Assign datasets for microsimulation and probability predictions
daily_urines <- tibble(ur_util %>% ungroup() %>% select(subject_id,micro_specimen_id,pAMPr:pTPN))
...
###Probability predictions minus Enterococcus spp.
reticulate::source_python("/Users/alexhoward/Documents/Projects/UDAST_code//UF_ent_train_test.py")
reticulate::source_python("/Users/alexhoward/Documents/Projects/UDAST_code//UF_ent_prediction_run.py")
